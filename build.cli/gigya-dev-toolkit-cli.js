...
state.option('--userKey [value]', t.GIGYA_USER_KEY).option('--userSecret [value]', t.GIGYA_USER_SECRET_KEY).option('--task [value]', t.TASK).option('--settings [value]', t.SETTINGS).option('--partnerId [value]', t.GIGYA_PARTNER_ID).option('--sourceApiKey [value]', t.SOURCE_GIGYA_SITE).option('--sourceFile [value]', t.SETTINGS_FILE).option('--destinationApiKeys [value]', t.DESTINATION_GIGYA_SITES).option('--newSiteBaseDomain [value]', t.NEW_SITE_BASE_DOMAIN).option('--newSiteDescription [value]', t.NEW_SITE_DESCRIPTION).option('--newSiteDataCenter [value]', t.NEW_SITE_DATA_CENTER).parse(process.argv);
